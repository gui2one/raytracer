...
bool Raycaster2::ray_triangle_intersect(Ray& ray, glm::vec3& vtx_a, glm::vec3& vtx_b, glm::vec3& vtx_c, glm::vec3& hit_pos)
{
...
glm::vec3 Raycaster2::screenToWorld(ClickData click_data, Camera& camera)
{
...
bool Raycaster2::intersectBoudingBox(
...
bool Raycaster2::intersectMeshes(ClickData click_data, Camera& camera, std::vector<Mesh>& meshes, HitData& _hit_data)
{
